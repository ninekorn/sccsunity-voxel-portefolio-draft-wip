...
thank you for trying my projects. it's far from perfect and it's not without bugs. i am happy if you find my projects inspiring in order for you to do your own work and programs with voxels in unity or not, but i deliver my assets to you as per mit license. I will clean my scripts as i go. oh, and when i say i develop things, it's because i spend so much time in front of my computer thinking by myself on how to resolve a problem doing trial and error. I don't mean nothing else by saying that. But as far as i know, i can throw my old backups projects files and the date that i created them, except those that i reference that are mostly opensourced or MIT assets and Creative Commons licensed assets. The rest i think by myself like a normal human beeing thinks also. so before thrashing my repo here, as my development in low-level was thrashed back then by trolls, but only when i release somewhere colder and more comfortable like github it feels good, so think before approaching me with all due respect, as my internet search of programming and cookies data trace of my mouse clicks and keyboard clicks could probably proove without a doubt, if the nsa could give it to me with all of the noise that i have never been doinge lately, that i am entirely and most probably and definitively the owner and creator of these assets. amen
