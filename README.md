...
myself with a lot of trial and error and headaches. rev4 available and it's a per frame voxel mesh builder that dictate how fast should the unqueuing of the Queues should go, and it's much faster than my previous revisions and it's smoother on the cpu to generate a voxel mesh:
