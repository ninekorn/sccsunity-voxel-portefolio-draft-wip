...
public class sccsikarm : MonoBehaviour
{
    ...
    GameObject prefabgameobjectempty;
    ...
    public void StartScript(Transform parent)
    {
        ...
        renderupperarm.transform.position = this.transform.position + new Vector3(0, 0, 0.35f / 2);
