...
public class sccscomputevoxelALLFACES : MonoBehaviour
{
    ...
    public void CreateTheArrays(int facetype)
    {
                    ...
                    for (int x = 0; x < mapx; x++)
                    {
                        for (int y = 0; y < mapy; y++)
                        {
                            for (int z = 0; z < mapz; z++)
                            {
                                ...
                                mapdata[mindex][index].position = new Vector3(mx * mapx * planesize, my * mapy * planesize, mz * mapz * planesize);
    ...
    public void CreateTheMesh(int facetype, List<Vector3>[] vertices, List<int>[] triangles)
    {
