...
public class sccsikplayer : MonoBehaviour
{
    ...
    public GameObject pelvisemptygameobject;
    public Transform pelvisrenderer;
    ...
    void Start()
    {
        ...
        pelvisemptygameobject = new GameObject();
        ...
        pelvisrenderer = GameObject.CreatePrimitive(PrimitiveType.Cube).transform;
        ...
        //themovementplayerscript.movementspeed = 1.5f;
