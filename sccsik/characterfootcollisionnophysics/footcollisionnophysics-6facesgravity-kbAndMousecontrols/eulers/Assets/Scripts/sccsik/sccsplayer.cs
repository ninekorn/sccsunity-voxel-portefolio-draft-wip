        ...
        */
        ...
        else
        {
            ...
            if (thedotplayertogravityside0 < 0 && indexofmaxvalueofperfacegravitydot > 0)
            {
                ...
                if (indexofmaxvalueofperfacegravitydot > 0.95f)
                {
                    

                    //if (thedotplayertogravityside1 > 0.95f)
                    {
        ...
        if (indexofmaxvalueofperfacegravity == 0 && indexofmaxvalueofperfacegravitylast != indexofmaxvalueofperfacegravity
            // && Mathf.Abs(Mathf.Abs(indexofmaxvalueofperfacegravitydotinvert) - Mathf.Abs(indexofmaxvalueofperfacegravitynextdotinvert)) > mingravitydotdiff
            ) //t
        {
            ...
            */
            ...
            /*
            if (indexofmaxvalueofperfacegravitylast == 3)
            {
                //toeuler.y = -toeuler.x;
                //eulerangles.y = 360-toeuler.x;
        ...
        else if (indexofmaxvalueofperfacegravity == 2 && indexofmaxvalueofperfacegravitylast != indexofmaxvalueofperfacegravity
        ) //r
        {
        ...
        else if (indexofmaxvalueofperfacegravity == 3 && indexofmaxvalueofperfacegravitylast != indexofmaxvalueofperfacegravity
            //&& Mathf.Abs(Mathf.Abs(indexofmaxvalueofperfacegravitydotinvert) - Mathf.Abs(indexofmaxvalueofperfacegravitynextdotinvert)) > mingravitydotdiff
            ) //fr
        {
            Vector3 eulerangles = new Vector3(viewer.transform.rotation.eulerAngles.x, viewer.transform.rotation.eulerAngles.y, viewer.transform.rotation.eulerAngles.z);
        ...
        */
        ...
        if (hasusingray == 1)
        {
            ...
            //else
            {
                ...
                {
                    if (haschangedsidesactivatewatch.ElapsedMilliseconds > 25) // && isMoving
                    {
