...
public class sccsikplayer : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        sccsplayer themovementplayerscript = this.transform.gameObject.GetComponent<sccsplayer>();
        ...
        for (int iarm = 0; iarm < 4; iarm++)
        {
            if (iarm == 0)
            {
                GameObject ikarm0 = new GameObject();
                ikarm0.transform.parent = torsorenderer.transform;

                ikarm0.SetActive(false);
                var ikarmscript0 = ikarm0.AddComponent<sccsikarm>();
                ...
                ikarmscript0.StartScript(torsorenderer.transform);

                ikarm0.transform.position = ikarmscript0.shoulderoriginpositionoffset;
                ikarm0.SetActive(true);
            }
            else if (iarm == 1)
            {
                GameObject ikarm1 = new GameObject();
                ikarm1.transform.parent = torsorenderer.transform;
                ...
                ikarmscript1.StartScript(torsorenderer.transform);

                ikarm1.transform.position = ikarmscript1.shoulderoriginpositionoffset;
            ...
            {
                GameObject ikarm0 = new GameObject();
                ikarm0.transform.parent = pelvisrenderer.transform;
                ...
                ikarmscript0.StartScript(pelvisrenderer.transform);
                ikarm0.transform.position = ikarmscript0.shoulderoriginpositionoffset;
            ...
            {
                GameObject ikarm1 = new GameObject();
                ikarm1.transform.parent = pelvisrenderer.transform;
                ...
                ikarmscript1.StartScript(pelvisrenderer.transform);
                ikarm1.transform.position = ikarmscript1.shoulderoriginpositionoffset;
                ...
                lengthofarm = ikarm1.gameObject.GetComponent<sccsikarm>().totalArmLength;
            }
