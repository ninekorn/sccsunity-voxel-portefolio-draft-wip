...
public class sccsbuffertest : MonoBehaviour
{
            ...
            //for (int my = 0; my < levelsizey; my++)
            {
                //for (int mz = 0; mz < levelsizez; mz++)
                {
                    ...
                    */
                    ...
                    compute.Dispatch(0, 1, 1, 1); //mapdata[mindex].Length/10 //mapdata[mindex].Length / 
                    ...
                    */
                        ...
                        for (int y = 0; y < mapy; y++)
                        {
                            for (int z = 0; z < mapz; z++)
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        int indexofvert00 = vertices.Count;
                                        ...
                                        int indexofvert01= vertices.Count;
                                        ...
                                        int indexofvert02 = vertices.Count;
                                        ...
                                        int indexofvert03 = vertices.Count;
                                        ...
                                        indices.Add(indexofvert02);
                                        indices.Add(indexofvert01);
                                        indices.Add(indexofvert00);
                                        indices.Add(indexofvert01);
                                        indices.Add(indexofvert02);
                                        indices.Add(indexofvert03);
                                        ...
                                        vert0.transform.localScale = new Vector3(0.010f, 0.005f, 0.005f);
                                        ...
                                        vert1.transform.localScale = new Vector3(0.0075f, 0.01f, 0.0075f);
                                        ...
                                        vert2.transform.localScale = new Vector3(0.005f, 0.005f, 0.01f);
                                        ...
                                        vert3.transform.localScale = new Vector3(0.005f, 0.015f, 0.005f);
                    ...
                    GameObject emptyobject0 = new GameObject();

                    emptyobject0.AddComponent<MeshFilter>();
                    emptyobject0.AddComponent<MeshRenderer>();

                    Mesh mesh = new Mesh();
                    emptyobject0.gameObject.GetComponent<MeshFilter>().mesh.Clear();
                    emptyobject0.gameObject.GetComponent<MeshFilter>().mesh = null;

                    emptyobject0.gameObject.GetComponent<MeshFilter>().mesh = mesh;
                    emptyobject0.GetComponent<MeshFilter>().sharedMesh = mesh;

                    /*
                    var verts = vertices[mindex].ToArray();
                    var tris = triangles[mindex].ToArray();*/

                    emptyobject0.GetComponent<MeshFilter>().mesh.Clear();
                    emptyobject0.GetComponent<MeshFilter>().mesh.vertices = vertices.ToArray();// vertices[mindex].ToArray();
                    emptyobject0.GetComponent<MeshFilter>().mesh.triangles = indices.ToArray();// triangles[mindex].ToArray();
                    //meshCollider.sharedMesh = null;
                    //meshCollider.sharedMesh = mesh;
                    emptyobject0.GetComponent<MeshFilter>().mesh.RecalculateBounds();
                    emptyobject0.GetComponent<MeshFilter>().mesh.RecalculateNormals();
                    emptyobject0.GetComponent<MeshRenderer>().material = mat;
                    emptyobject0.transform.localScale = new Vector3(0.1f, 0.1f, 0.1f);
