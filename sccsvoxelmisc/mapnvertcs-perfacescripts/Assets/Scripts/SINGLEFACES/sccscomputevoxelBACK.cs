...
public class sccscomputevoxelBACK : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        emptyobjectparent0.gameObject.name = "topfacesmain";
            ...
            for (int my = 0; my < levelsizey; my++)
            {
                for (int mz = 0; mz < levelsizez; mz++)
                {
                    ...
                    */
                    ...
                    if (emptyobject.GetComponent<MeshFilter>() == null)
                    {
                        var meshfilt = emptyobject.AddComponent<MeshFilter>();

                    }

                    if (emptyobject.GetComponent<MeshRenderer>() == null)
                    {
