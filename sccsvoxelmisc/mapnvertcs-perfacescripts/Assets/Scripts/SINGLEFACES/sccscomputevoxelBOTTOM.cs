...
public class sccscomputevoxelBOTTOM : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        emptyobjectparent0.gameObject.name = "bottomfacesmain";
            ...
            for (int my = 0; my < levelsizey; my++)
            {
                for (int mz = 0; mz < levelsizez; mz++)
                {
                    ...
                    *///_testChunk.GetComponent<MeshRenderer>().material = _mat;
                    ...
                    //Debug.Log("sccscomputevoxelBOTTOM:" + "/triangles:" + triangles.Count);
                    ...
                    emptyobject.gameObject.name = "bottom faces";
                    emptyobject.transform.name = "bottom faces";
