...
public class sccscomputevoxelFRONT : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        emptyobjectparent0.gameObject.name = "frontfacesmain";
            ...
            for (int my = 0; my < levelsizey; my++)
            {
                for (int mz = 0; mz < levelsizez; mz++)
                {
                    ...
                    *///_testChunk.GetComponent<MeshRenderer>().material = _mat;
                    ...
                    //Debug.Log("sccscomputevoxelfront:" + "/triangles:" + triangles.Count);
                    ...
                    emptyobject.gameObject.name = "front faces";
                    emptyobject.transform.name = "front faces";
