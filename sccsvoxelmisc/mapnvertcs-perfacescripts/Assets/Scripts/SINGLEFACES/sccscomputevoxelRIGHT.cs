...
public class sccscomputevoxelRIGHT : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        emptyobjectparent0.gameObject.name = "rightfacesmain";
            ...
            for (int my = 0; my < levelsizey; my++)
            {
                for (int mz = 0; mz < levelsizez; mz++)
                {
                    ...
                    *///_testChunk.GetComponent<MeshRenderer>().material = _mat;
                    ...
                    //Debug.Log("sccscomputevoxelRIGHT:" + "/triangles:" + triangles.Count);
                    ...
                    emptyobject.gameObject.name = "right faces";
                    emptyobject.transform.name = "right faces";
