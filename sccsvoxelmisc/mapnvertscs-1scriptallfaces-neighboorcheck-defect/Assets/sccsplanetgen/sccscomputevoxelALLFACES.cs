                                        ...
                                        if (sextremityyl == 1)
                                        {
                                            ...
                                            if (ymap == 0)
                                            {
                                                ...
                                                if (planetdivtothetop != null)
                                                {
                                                    ...
                                                    var planetdivchunk = getChunk(x, schunkhr, z);
        ...
        for (int x = -schunkwl; x <= schunkwr; x++)
        {
            for (int y = -schunkhl; y <= schunkhr; y++)
            {
                for (int z = -schunkdl; z <= schunkdr; z++)
                {
                    ...
                    blockers[indexflat].chunkpos = chunkmainpos;// this.transform.TransformPoint(chunkmainpos);//.tra chunkmainpos;
                    ...
                    GameObject emptyobject = NewObjectPoolerScript.current.GetPooledObject();// this.transform.gameObject.GetComponent<NewObjectPoolerScript>().GetPooledObject();
