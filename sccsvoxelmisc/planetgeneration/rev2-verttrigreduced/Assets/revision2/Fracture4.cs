    ...
    void Start()
    {
        ...
        if (tetraHedron.Count == 12)
        {
            ...
            for (int i = 0; i < newTrianglesCount / 4; i++)
            {
                ...
                Material newMat = Resources.Load("Materials/FracColor0", typeof(Material)) as Material;
                ...
                {
                    Resources.Load("Materials/FracColor0") as Material,
                    Resources.Load("Materials/FracColor1") as Material,
                    Resources.Load("Materials/FracColor2") as Material,
                    Resources.Load("Materials/FracColor3") as Material,
                };
                ...
                var o_239_17_636211226961312820 = FracturingObj[i].transform.gameObject.GetComponent<MeshFilter>().mesh;
                ...
                //AssetDatabase.CreateAsset(fracMesh, "Assets/Meshes" + FracturingObj[i].gameObject.name + ".asset");
        ...
        else
        {
            ...
            for (int i = 0; i < newTrianglesCount / 4; i++)
            {
                ...
                //AssetDatabase.CreateAsset(fracMesh, "Assets/Meshes" + FracturingObj[i].gameObject.name);
                //AssetDatabase.SaveAssets();
