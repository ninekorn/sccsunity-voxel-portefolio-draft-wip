...
public class sccsproceduralplanetbuilderGen3 : MonoBehaviour
{
    ...
    static mainChunkGen3[] blockersgen2;
    ...
    private void Start()
    {
        ...
        //blockersgen2 = new mainChunkGen3[total];
    ...
    public static int haspressedmouser = 0;
    public static int haspressedmousel = 0;

    public static bool haspressedmouseboolr = false;
    public static bool haspressedmousebooll = false;
    ...
    private void Update()
    {
        ...
        haspressedmouseboolr = Input.GetMouseButton(1);
        haspressedmousebooll = Input.GetMouseButton(0);
                        ...
                        try
                        {
                            ...
                            if (taskcancelFlagTwo == 2 || taskcancelFlagTwo == 4)
                            {
                                ...
                                if (swtcForTypeOfInteract == 1)
                                {
                                    ...
                                    bool buttonPressedLeft = haspressedmousebooll;// OVRInput.Get(OVRInput.Button.PrimaryHandTrigger, OVRInput.Controller.LTouch);
                                    bool buttonPressedRight = haspressedmouseboolr;// OVRInput.Get(OVRInput.Button.PrimaryHandTrigger, OVRInput.Controller.RTouch);
    ...
    public mainChunkGen3 getChunkmainChunkGen3(int x, int y, int z)
    {
        if ((x < -ChunkWidth_L) || (y < -ChunkHeight_L) || (z < -ChunkDepth_L) || (x >= ChunkWidth_R + 1) || (y >= (ChunkHeight_R + 1)) || (z >= (ChunkDepth_R + 1)))
        {
            return null;
