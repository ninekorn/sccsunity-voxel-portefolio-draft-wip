...
public class SC_Terrain : MonoBehaviour
{
    ...
    {
        public chunkDatascterrain[] _arrayOfIndividualChunks;
        Vector3 _position;
        ...
        public _smallChunkData(chunkDatascterrain[] arrayOfIndividualChunks, Vector3 position)
        {
            this._arrayOfIndividualChunks = arrayOfIndividualChunks;
            this._position = position;
        }
    }
    public int _combineMax = 2;

    public int _mapWidth = 10;
    public int _mapHeight = 10;
    public int _mapDepth = 10;
    ...
    public static chunkDatascterrain[] _arrayOfChunkData;
    ...
    {      
        ...
        _arrayOfChunkData = new chunkDatascterrain[_totalWidth * _totalHeight * _totalDepth];
    ...
    _smallChunkData checkForSmallChunk(chunkDatascterrain[] _arrayOfChunkData, int[] _arrayOfChunk, Vector3 _bigChunkPos, Vector3 _areaChunkPos) //, _smallChunkData _smallChunker
    {
    ...
    Queue<chunkDatascterrain> _dispatcherToMainThread = new Queue<chunkDatascterrain>();
