...
public class chunkscterrainrev2
{
    ...
    void buildTopFace(int xi, int yi, int zi, Vector3 chunkPos) //int _x, int _y, int _z, Vector3 chunkPos
    {
        _maxWidth = _width;
        _maxDepth = _depth;
        _maxHeight = _height;
        ...
        int block = _tempChunkArray[xi + _width * (yi + _height * zi)];
            ...
            if (IsTransparent(xi, yi + 1, zi))
            {
                for (int _xx = 0; _xx < _maxWidth; _xx++)
                {
                    ...
                    for (int _zz = 0; _zz < _maxDepth; _zz++)
                    {
                        ...
                        if (rowIterateX < _width && rowIterateZ < _depth)
                        {
                            ...
                            //if (someswtc == 1)
                            {
                                if (_xx == 0 && _zz == 0)
                                {
                                    ...
                                    {
                                        block = _tempChunkArray[(rowIterateX + 1) + _width * ((yi) + _height * (rowIterateZ))];
                                        ...
                                        else if (block == 1 || block == 2)
                                        {
                                            ...
                                            {
                                                block = _tempChunkArray[(rowIterateX + 1) + _width * ((yi + 1) + _height * (rowIterateZ))];
                                    ...
                                    {
                                        block = _tempChunkArray[(rowIterateX) + _width * ((yi) + _height * (rowIterateZ + 1))];
                                        ...
                                        else if (block == 1 || block == 2) //block == 1||
                                        {
                                            if (block == 1)
                                            {
                                                ...
                                                {
                                                    block = _tempChunkArray[(rowIterateX) + _width * ((yi + 1) + _height * (rowIterateZ + 1))];
                        ...
                        {
                            _tempChunkArray[(rowIterateX) + _width * (yi + _height * (rowIterateZ))] = 2;
    ...
    void buildBottomFace(int xi, int yi, int zi, Vector3 _chunkPos) //int _x, int _y, int _z, Vector3 chunkPos
    {
        _maxWidth = _width;
        _maxDepth = _depth;
        _maxHeight = _height;
