...
public class sccscomputevoxelshrinkedALLFACES : MonoBehaviour
{
                    ...
                    for (int x = 0; x < mapx; x++)
                    {
                        for (int y = 0; y < mapy; y++)
                        {
                            for (int z = 0; z < mapz; z++)
                            {
                                ...
                                mapdata[mindex][index].position = new Vector3(mx * mapx * 0.1f, my * mapy * 0.1f, mz * mapz * 0.1f) + chunkmainpos;
    ...
    public int[] workonshader(Vector3 chunkpos, GameObject thecurrentchunk, out List<Vector3> vertices,out List<int> triangles)
    {
    ...
    public int[] CSWorkOnMapOnly(Vector3 chunkpos)
    {
        int mindex = 0;
        int[] mapint;// = new int[mapx * mapy * mapz];
    ...
    public void workontherest(Vector3 chunkpos, GameObject thecurrentchunk, out List<Vector3> vertices, out List<int> triangles)
    {
        ...
        Vector3 chunkmainpos = new Vector3(mx * mapx * 0.1f, my * mapy * 0.1f, mz * mapz * 0.1f) + chunkpos;
