...
public class chunkforwrap
{
    ...
    public universewraprev1.meshData startBuildingArray(Vector3 currentPosition, Vector3 fakePos)
    {
        ...
        if (positions.Length > 0)
        {
            ...
            return new universewraprev1.meshData(fakePos, currentPosition, positions.Length, positions, triangleIndices);
        }
        else
        {
            return new universewraprev1.meshData(fakePos, currentPosition, 0, positions, triangleIndices);
        }
    }
