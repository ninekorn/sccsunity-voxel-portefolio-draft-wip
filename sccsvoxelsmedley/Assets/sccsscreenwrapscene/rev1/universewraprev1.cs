...
public class universewraprev1 : MonoBehaviour
{
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if (regionChunky.areaChunkyArray[areaX, areaY, areaZ].bigChunkyArray[bigXX, bigYY, bigZZ].smallChunkerList[smallXX, smallYY, smallZZ] == null)
                            {
                                ...
                                universewraprev1.meshData meshDator = chunki.startBuildingArray(truePos, fakePos);

                                if (meshDator.lengthOfArray > 0)
                                {
                                    lock (meshDataThreadInfoQueue)
                                    {
                                        meshDataThreadInfoQueue.Enqueue(new meshThreadInfo<universewraprev1.meshData>(callback, meshDator));
                                    }
                                }
                            }
