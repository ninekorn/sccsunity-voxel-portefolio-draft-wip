...
public class InfiniteUniverserev2 : MonoBehaviour
{
    ...
    public InfiniteUniverserev2 currentInfiniteUniverse;
    ...
    public int chunkWidthSquared = 4; //144

    public int chunkTinyWidth = 4; //3
    public int chunkTinyHeight = 4; //144
    public int chunkTinyDepth = 4; //3
    ...
    void Update()
    {
        ...
        IAmMoving = infini.amIMoving;
        currentRealPos = infini.realPosition;
        fakePosition = infini.fakePosition;
