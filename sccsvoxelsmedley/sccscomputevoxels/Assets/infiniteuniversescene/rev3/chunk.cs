...
namespace OculusProjektV0
{
    public class chunk
    {
        ...
        private smallChunk chuking;

        ///bigChunk chunkero;
        smallChunk[,,] smallChunker = new smallChunk[1, 1, 1];
        ...
        public threadInfinite.meshData startBuildingArray(Vector3 currentPosition)//,int xx,int yy,int zz,bigChunk bigChunk, smallChunk smallChunk)
        {
            ...
            if (positions.Length > 0)
            {
                ...
                return new threadInfinite.meshData(currentPosition, positions.Length,positions,triangleIndices); //, bigChunk, smallChunk
            }
            else
            {
                return new threadInfinite.meshData(currentPosition, 0, positions,triangleIndices); //, bigChunk = null, smallChunk = null
            }
        }
