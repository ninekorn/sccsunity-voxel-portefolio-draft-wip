...
public class sccsplanetchunkrev1 : MonoBehaviour
{
    ...
    sccsproceduralplanetbuilderrev1 componentParent;
    ...
    public void buildchunkmap()
    {
        ...
        componentParent = parentObject.gameObject.GetComponent<sccsproceduralplanetbuilderrev1>();
        ...
        //GetComponent<sccsplanetchunkrev1>().enabled = false;
    }
    ...
    public void DrawBrick(int x, int y, int z)
    {
        ...
        else if (x == width - 1)
        {
            if (componentParent.getChunk((int)(transform.position.x + 4), (int)(transform.position.y), (int)(transform.position.z)) != null)
            {
                ...
                if (chunkdata != null)
                {
                    var comp = chunkdata.planetchunk.GetComponent<sccsplanetchunkrev1>();
