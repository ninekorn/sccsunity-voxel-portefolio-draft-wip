...
public class sccsproceduralplanetbuilderrev1 : MonoBehaviour
{
    ...
    float chunkPlanetSpawnSpeed = 0.5f;
    ...
    void Awake()
    {
        ...
        //InvokeRepeating("buildplanetchunk", chunkPlanetSpawnSpeed, chunkPlanetSpawnSpeed);
    }
        ...
        for (int x = -ChunkWidth_L; x <= ChunkWidth_R; x += 4)
        {
            for (int y = -ChunkHeight_L; y <= ChunkHeight_R; y += 4)
            {
                for (int z = -ChunkDepth_L; z <= ChunkDepth_R; z += 4)
                {
                    ...
                    if (yo.GetComponent<sccsplanetchunkrev1>() != null)
                    {
                        //Debug.Log("!null");
                        yo.GetComponent<sccsplanetchunkrev1>().buildchunkmap();
                    ...
                    blockers[_index].planetchunk.GetComponent<sccsplanetchunkrev1>().buildchunkmap();
        ...
        for (int x = -ChunkWidth_L; x <= ChunkWidth_R; x += 4)
        {
            for (int y = -ChunkHeight_L; y <= ChunkHeight_R; y += 4)
            {
                for (int z = -ChunkDepth_L; z <= ChunkDepth_R; z += 4)
                {
                    ...
                    blockers[_index].planetchunk.GetComponent<sccsplanetchunkrev1>().Regenerate();
                    blockers[_index].planetchunk.GetComponent<sccsplanetchunkrev1>().buildMesh();
