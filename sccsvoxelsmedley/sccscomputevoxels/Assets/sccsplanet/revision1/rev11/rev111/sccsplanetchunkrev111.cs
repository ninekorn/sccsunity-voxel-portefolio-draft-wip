...
public class sccsplanetchunkrev111 : MonoBehaviour
{
    /*
    ...
    private float radiusplanetcorestart = 0.0f;
    private float radiusplanetcoreend = 0.15f;
    private float radiusplanetcavesstart = 0.15f;
    ...
    private float radiusplanetmountainend = 1.0f;
    ...
    sccsproceduralplanetbuilderrev111 componentParent;
    Transform parentObject;

    public void buildchunkmap()
    {
        float maxsizex = sccsproceduralplanetbuilderrev111.currentsccsproceduralplanetbuilderrev111.ChunkWidth_L + sccsproceduralplanetbuilderrev111.currentsccsproceduralplanetbuilderrev111.ChunkWidth_R + 1;
        float maxsizey = sccsproceduralplanetbuilderrev111.currentsccsproceduralplanetbuilderrev111.ChunkHeight_L + sccsproceduralplanetbuilderrev111.currentsccsproceduralplanetbuilderrev111.ChunkHeight_R + 1;
        float maxsizez = sccsproceduralplanetbuilderrev111.currentsccsproceduralplanetbuilderrev111.ChunkDepth_L + sccsproceduralplanetbuilderrev111.currentsccsproceduralplanetbuilderrev111.ChunkDepth_R + 1;


        float sizeofplanetboundingbox = (maxsizex * maxsizey * maxsizez) * (width*height*depth) * planeSize;


        Debug.Log("buildchunkmap" + "sccsplanetchunkrev111" + sizeofplanetboundingbox);
        if (sizeofplanetboundingbox < radiusplanetmountainend)
        {

        }


        //radiusplanetmountainend = 


        //radiusplanetcavesend
        ...
        componentParent = parentObject.gameObject.GetComponent<sccsproceduralplanetbuilderrev111>();
        ...
        //GetComponent<sccsplanetchunkrev111>().enabled = false;
    }
    ...
    public void DrawBrick(int x, int y, int z)
    {
        ...
        else if (x == width - 1)
        {
            ...
            {
                sccsproceduralplanetbuilderrev111.mainChunk chunkdata = componentParent.getChunk((int)(transform.position.x + 4), (int)(transform.position.y), (int)(transform.position.z));
                ...
                if (chunkdata != null)
                {
                    var comp = chunkdata.planetchunk.GetComponent<sccsplanetchunkrev111>();
        ...
        {
            sccsproceduralplanetbuilderrev111.mainChunk chunkdata = componentParent.getChunk((int)(transform.position.x), (int)(transform.position.y), (int)(transform.position.z - 4));
        ...
        {
            sccsproceduralplanetbuilderrev111.mainChunk chunkdata = componentParent.getChunk((int)(transform.position.x), (int)(transform.position.y + 4), (int)(transform.position.z));
