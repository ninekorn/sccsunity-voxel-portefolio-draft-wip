...
public class sccsproceduralplanetbuilderrev111 : MonoBehaviour
{
    public static sccsproceduralplanetbuilderrev111 currentsccsproceduralplanetbuilderrev111;
    ...
    void Awake()
    {
        currentsccsproceduralplanetbuilderrev111 = this;
        ...
        for (int x = -ChunkWidth_L; x <= ChunkWidth_R; x += 4)
        {
            for (int y = -ChunkHeight_L; y <= ChunkHeight_R; y += 4)
            {
                for (int z = -ChunkDepth_L; z <= ChunkDepth_R; z += 4)
                {
                    ...
                    if (yo.GetComponent<sccsplanetchunkrev111>() != null)
                    {
                        //Debug.Log("!null");
                        yo.GetComponent<sccsplanetchunkrev111>().buildchunkmap();
                    ...
                    blockers[_index].planetchunk.GetComponent<sccsplanetchunkrev111>().buildchunkmap();
        ...
        for (int x = -ChunkWidth_L; x <= ChunkWidth_R; x += 4)
        {
            for (int y = -ChunkHeight_L; y <= ChunkHeight_R; y += 4)
            {
                for (int z = -ChunkDepth_L; z <= ChunkDepth_R; z += 4)
                {
                    ...
                    blockers[_index].planetchunk.GetComponent<sccsplanetchunkrev111>().Regenerate();
                    blockers[_index].planetchunk.GetComponent<sccsplanetchunkrev111>().buildMesh();
