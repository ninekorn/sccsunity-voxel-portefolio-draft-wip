...
public class sccsplanetchunkrev11 : MonoBehaviour
{
    ...
    sccsproceduralplanetbuilderrev11 componentParent;
    ...
    public void buildchunkmap()
    {
        ...
        componentParent = parentObject.gameObject.GetComponent<sccsproceduralplanetbuilderrev11>();
        ...
        //GetComponent<sccsplanetchunkrev11>().enabled = false;
    }
    ...
    public void DrawBrick(int x, int y, int z)
    {
        ...
        else if (x == width - 1)
        {
            ...
            {
                sccsproceduralplanetbuilderrev11.mainChunk chunkdata = componentParent.getChunk((int)(transform.position.x + 4), (int)(transform.position.y), (int)(transform.position.z));
                ...
                if (chunkdata != null)
                {
                    var comp = chunkdata.planetchunk.GetComponent<sccsplanetchunkrev11>();
        ...
        {
            sccsproceduralplanetbuilderrev11.mainChunk chunkdata = componentParent.getChunk((int)(transform.position.x), (int)(transform.position.y), (int)(transform.position.z - 4));
        ...
        {
            sccsproceduralplanetbuilderrev11.mainChunk chunkdata = componentParent.getChunk((int)(transform.position.x), (int)(transform.position.y + 4), (int)(transform.position.z));
