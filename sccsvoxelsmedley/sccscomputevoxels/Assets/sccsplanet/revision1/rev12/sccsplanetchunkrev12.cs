...
public class sccsplanetchunkrev12 : MonoBehaviour
{
    ...
    */
    ...
    private float radiusplanetcorestart = 0.0f;
    private float radiusplanetcoreend = 0.35f;
    private float radiusplanetcavesstart = 0.35f;
    private float radiusplanetcavesend = 0.70f;
    private float radiusplanetcruststart = 0.70f;
    private float radiusplanetcrustend = 0.85f;
    private float radiusplanetmountainstart = 0.85f;
    private float radiusplanetmountainend = 0.954321f;//0.999999f;
    ...
    //sccsproceduralplanetbuilderrev12 componentParent;
    ...
    public sccsproceduralplanetbuilderrev12.mainChunk buildchunkmap(sccsproceduralplanetbuilderrev12.mainChunk mainChunk)
    {
        ...
        float mountainend = radiusplanetmountainend;
        //float sizecalc = (width * planeSize) * (height * planeSize) * (depth* planeSize);
        float sizecalceachbytechunk = (width * planeSize) * (height * planeSize) * (depth * planeSize);

        float sizex = (sccsproceduralplanetbuilderrev12.sccsproceduralplanetbuilderrev12script.ChunkWidth_L + sccsproceduralplanetbuilderrev12.sccsproceduralplanetbuilderrev12script.ChunkWidth_R + 1);
        float sizey = (sccsproceduralplanetbuilderrev12.sccsproceduralplanetbuilderrev12script.ChunkHeight_L + sccsproceduralplanetbuilderrev12.sccsproceduralplanetbuilderrev12script.ChunkHeight_R + 1);
        float sizez = (sccsproceduralplanetbuilderrev12.sccsproceduralplanetbuilderrev12script.ChunkDepth_L + sccsproceduralplanetbuilderrev12.sccsproceduralplanetbuilderrev12script.ChunkDepth_R + 1);
        ...
        radiusplanetcoreend = radiusplanetmountainend * 0.35f;
        radiusplanetcavesend = radiusplanetmountainend * 0.55f;
        radiusplanetcrustend = radiusplanetmountainend * 0.75f;


        //Debug.Log(radiusplanetmountainend);

        // radiusplanetcoreend = radiusplanetmountainend * 0.0025f;
        //radiusplanetcavesend = radiusplanetmountainend * 0.0065f;
        ...
        //componentParent = parentObject.gameObject.GetComponent<sccsproceduralplanetbuilderrev12>();
       ...
       */
        ...
        //GetComponent<sccsplanetchunkrev12>().enabled = false;
    ...
    public sccsproceduralplanetbuilderrev12.mainChunk buildMesh(sccsproceduralplanetbuilderrev12.mainChunk mainChunk)
    {
        ...
        //to readd
        //to readd
        if (mainChunk.planetchunk.gameObject.GetComponent<MeshCollider>() == null)
        {
            mainChunk.planetchunk.gameObject.AddComponent<MeshCollider>();
        }
        else
        {
            Destroy(mainChunk.planetchunk.gameObject.GetComponent<MeshCollider>());
            mainChunk.planetchunk.gameObject.AddComponent<MeshCollider>();
    ...
    //sccsproceduralplanetbuilderrev12 sccsproceduralplanetbuilderrev12script,
    public sccsproceduralplanetbuilderrev12.mainChunk Regenerate(sccsproceduralplanetbuilderrev12.mainChunk mainChunk)
    {
    ...
    public sccsproceduralplanetbuilderrev12.mainChunk DrawBrick(int x, int y, int z, sccsproceduralplanetbuilderrev12.mainChunk mainChunk)
    {
        //Debug.Log(map[x,y,z]);
        ...
        */
        ...
        {
            var chunkdata = sccsproceduralplanetbuilderrev12.sccsproceduralplanetbuilderrev12script.getChunk((int)(mainChunk.indexposx + 1), (int)(mainChunk.indexposy), (int)(mainChunk.indexposz));
            if (chunkdata != null)
            {
                //sccsproceduralplanetbuilderrev12.mainChunk chunkdata = sccsproceduralplanetbuilderrev12.sccsproceduralplanetbuilderrev12script.getChunk((int)(mainChunk.indexposx + 1), (int)(mainChunk.indexposy), (int)(mainChunk.indexposz));
        ...
        if (y == height - 1)
        {
            sccsproceduralplanetbuilderrev12.mainChunk chunkdata = sccsproceduralplanetbuilderrev12.sccsproceduralplanetbuilderrev12script.getChunk((int)(mainChunk.indexposx), (int)(mainChunk.indexposy + 1), (int)(mainChunk.indexposz));
    ...
    public sccsproceduralplanetbuilderrev12.mainChunk DrawFace(Vector3 start, Vector3 offset1, Vector3 offset2, sccsproceduralplanetbuilderrev12.mainChunk mainChunk)
    {
    ...
    public void SetByte(int x, int y, int z, byte block, sccsproceduralplanetbuilderrev12.mainChunk mainChunk)
    {
    ...
    public bool IsTransparent(int x, int y, int z, sccsproceduralplanetbuilderrev12.mainChunk mainChunk)
    {
        int indexOf = x + width * (y + depth * z);
    ...
    public byte GetByte(int x, int y, int z, sccsproceduralplanetbuilderrev12.mainChunk mainChunk)
    {
        int indexOf = x + width * (y + depth * z);
