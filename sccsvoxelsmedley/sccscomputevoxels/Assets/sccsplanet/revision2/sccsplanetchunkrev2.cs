...
public class sccsplanetchunkrev2 : MonoBehaviour
{
    ...
    sccsproceduralplanetbuilderrev2 componentParent;
    ...
    public void buildchunkmap()
    {
        ...
        componentParent = parentObject.gameObject.GetComponent<sccsproceduralplanetbuilderrev2>();
        ...
        //GetComponent<sccsplanetchunkrev2>().enabled = false;
    }
    ...
    public void DrawBrick(int x, int y, int z)
    {
        ...
        else if (x == width - 1)
        {
            ...
            {
                sccsproceduralplanetbuilderrev2.mainChunk chunkdata = componentParent.getChunk((int)(transform.position.x + 4), (int)(transform.position.y), (int)(transform.position.z));
                ...
                if (chunkdata != null)
                {
                    var comp = chunkdata.planetchunk.GetComponent<sccsplanetchunkrev2>();
        ...
        {
            sccsproceduralplanetbuilderrev2.mainChunk chunkdata = componentParent.getChunk((int)(transform.position.x), (int)(transform.position.y), (int)(transform.position.z - 4));
        ...
        {
            sccsproceduralplanetbuilderrev2.mainChunk chunkdata = componentParent.getChunk((int)(transform.position.x), (int)(transform.position.y + 4), (int)(transform.position.z));
