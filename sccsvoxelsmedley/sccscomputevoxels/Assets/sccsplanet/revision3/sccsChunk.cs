...
public struct sccsChunk
{
    ...
    public sccsproceduralplanetbuilderGen3 componentParent;
    ...
    public void sccsCustomStart(Transform planetchunk_, Vector3 chunkpos_, float planeSize_, float realplanetwidth_, int width_, int height_, int depth_, sccsproceduralplanetbuilderGen3 componentParent_, int addfracturedcubeonimpact_, NewObjectPoolerScript UnityTutorialGameObjectPool_)
    {
        ...
        //componentParent = parentObject.gameObject.GetComponent<sccsproceduralplanetbuilderGen3>().currentplanetbuilder;
