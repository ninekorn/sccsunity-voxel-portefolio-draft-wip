...
public class sccsplanetchunkrev4// : MonoBehaviour
{
    ...
    */
    ...
    //sccsproceduralplanetbuilderrev4 componentParent;
    ...
    public sccsproceduralplanetbuilderrev4.mainChunk buildchunkmap(sccsproceduralplanetbuilderrev4.mainChunk mainChunk)
    {
        ...
        //componentParent = parentObject.gameObject.GetComponent<sccsproceduralplanetbuilderrev4>();
       ...
       */
        ...
        //GetComponent<sccsplanetchunkrev4>().enabled = false;
    ...
    public sccsproceduralplanetbuilderrev4.mainChunk buildMesh(sccsproceduralplanetbuilderrev4.mainChunk mainChunk)
    {
        mesh = new Mesh();
    ...
    //sccsproceduralplanetbuilderrev4 sccsproceduralplanetbuilderrev4script,
    public sccsproceduralplanetbuilderrev4.mainChunk Regenerate(sccsproceduralplanetbuilderrev4.mainChunk mainChunk)
    {
    ...
    public sccsproceduralplanetbuilderrev4.mainChunk DrawBrick(int x, int y, int z, sccsproceduralplanetbuilderrev4.mainChunk mainChunk)
    {
        //Debug.Log(map[x,y,z]);
    ...
    public sccsproceduralplanetbuilderrev4.mainChunk DrawFace(Vector3 start, Vector3 offset1, Vector3 offset2, sccsproceduralplanetbuilderrev4.mainChunk mainChunk)
    {
    ...
    public void SetByte(int x, int y, int z, byte block,sccsproceduralplanetbuilderrev4.mainChunk mainChunk)
    {
    ...
    public bool IsTransparent(int x, int y, int z, sccsproceduralplanetbuilderrev4.mainChunk mainChunk)
    {
        int indexOf = x + width * (y + depth * z);
    ...
    public byte GetByte(int x, int y, int z, sccsproceduralplanetbuilderrev4.mainChunk mainChunk)
    {
        int indexOf = x + width * (y + depth * z);
