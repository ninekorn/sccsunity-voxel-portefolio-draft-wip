...
public class playerInteractionrev12 : MonoBehaviour
{
                    ...
                    if (collision.transform.tag == "collisionObject")
                    {
                        ...
                        if (planetmanager.GetComponent<sccsproceduralplanetbuilderrev12>().getChunk((int)collision.transform.position.x, (int)collision.transform.position.y, (int)collision.transform.position.z) != null)
                        {
                            ...
                            if (collision.contacts[0].normal.x == 0 && collision.contacts[0].normal.y == 0 && collision.contacts[0].normal.z == -1) //FRONT FACE
                            {
                                ...
                                currentChunk.planetchunk.GetComponent<sccsplanetchunkrev12>().Regenerate(adjacentChunk);
                                currentChunk.planetchunk.GetComponent<sccsplanetchunkrev12>().buildMesh(adjacentChunk);
    ...
    public void setAdjacentChunks(sccsproceduralplanetbuilderrev12.mainChunk currentChunk, Vector3 pos, int indexX, int indexY, int indexZ)
    {
        ...
        if (indexX == 0)
        {
            if (planetmanager.GetComponent<sccsproceduralplanetbuilderrev12>().getChunk((int)pos.x - 4, (int)pos.y, (int)pos.z) != null)
            {
                ...
                if (adjacentChunk.planetchunk.GetComponent<sccsplanetchunkrev12>().GetByte((int)width - 1, (int)indexY, (int)indexZ, adjacentChunk) == 1)
                {
                    ////Debug.Log("adjacent chunk left exists");
                    adjacentChunk.planetchunk.GetComponent<sccsplanetchunkrev12>().SetByte((int)width - 1, (int)indexY, (int)indexZ, 1, adjacentChunk);
                    adjacentChunk.planetchunk.GetComponent<sccsplanetchunkrev12>().Regenerate(adjacentChunk);
                    adjacentChunk.planetchunk.GetComponent<sccsplanetchunkrev12>().buildMesh(adjacentChunk);
                }
            }
        }
        ...
        if (indexX == width - 1)
        {
            if (planetmanager.GetComponent<sccsproceduralplanetbuilderrev12>().getChunk((int)pos.x + 4, (int)pos.y, (int)pos.z) != null)
            {
                ...
                if (adjacentChunk.planetchunk.GetComponent<sccsplanetchunkrev12>().GetByte((int)0, (int)indexY, (int)indexZ, adjacentChunk) == 1)
                {
                    ////Debug.Log("adjacent chunk right exists");
                    adjacentChunk.planetchunk.GetComponent<sccsplanetchunkrev12>().SetByte((int)0, (int)indexY, (int)indexZ, 1, adjacentChunk);
                    adjacentChunk.planetchunk.GetComponent<sccsplanetchunkrev12>().Regenerate(adjacentChunk);
                    adjacentChunk.planetchunk.GetComponent<sccsplanetchunkrev12>().buildMesh(adjacentChunk);
                }
            }
        ...
        if (indexY == 0)
        {
            if (planetmanager.GetComponent<sccsproceduralplanetbuilderrev12>().getChunk((int)pos.x, (int)pos.y - 4, (int)pos.z) != null)
            {
                ...
                if (adjacentChunk.planetchunk.GetComponent<sccsplanetchunkrev12>().GetByte((int)indexX, (int)height - 1, (int)indexZ, adjacentChunk) == 1)
                {
                    ////Debug.Log("adjacent chunk left exists");
                    adjacentChunk.planetchunk.GetComponent<sccsplanetchunkrev12>().SetByte((int)indexX, (int)height - 1, (int)indexZ, 1, adjacentChunk);
                    adjacentChunk.planetchunk.GetComponent<sccsplanetchunkrev12>().Regenerate(adjacentChunk);
                    adjacentChunk.planetchunk.GetComponent<sccsplanetchunkrev12>().buildMesh(adjacentChunk);
                }
            }
        ...
        if (indexY == height - 1)
        {
            if (planetmanager.GetComponent<sccsproceduralplanetbuilderrev12>().getChunk((int)pos.x, (int)pos.y + 4, (int)pos.z) != null)
            {
                ...
                if (adjacentChunk.planetchunk.GetComponent<sccsplanetchunkrev12>().GetByte((int)indexX, (int)0, (int)indexZ, adjacentChunk) == 1)
                {
                    ////Debug.Log("adjacent chunk left exists");
                    adjacentChunk.planetchunk.GetComponent<sccsplanetchunkrev12>().SetByte((int)indexX, (int)0, (int)indexZ, 1, adjacentChunk);
                    adjacentChunk.planetchunk.GetComponent<sccsplanetchunkrev12>().Regenerate(adjacentChunk);
                    adjacentChunk.planetchunk.GetComponent<sccsplanetchunkrev12>().buildMesh(adjacentChunk);
                }
            }
        ...
        if (indexZ == 0)
        {
            if (planetmanager.GetComponent<sccsproceduralplanetbuilderrev12>().getChunk((int)pos.x, (int)pos.y, (int)pos.z - 4) != null)
            {
                ...
                if (adjacentChunk.planetchunk.GetComponent<sccsplanetchunkrev12>().GetByte((int)indexX, (int)indexY, (int)depth - 1, adjacentChunk) == 1)
                {
                    ////Debug.Log("adjacent chunk left exists");
                    adjacentChunk.planetchunk.GetComponent<sccsplanetchunkrev12>().SetByte((int)indexX, (int)indexY, (int)depth - 1, 1, adjacentChunk);
                    adjacentChunk.planetchunk.GetComponent<sccsplanetchunkrev12>().Regenerate(adjacentChunk);
                    adjacentChunk.planetchunk.GetComponent<sccsplanetchunkrev12>().buildMesh(adjacentChunk);
                }
            }
        ...
        if (indexZ == depth - 1)
        {
            if (planetmanager.GetComponent<sccsproceduralplanetbuilderrev12>().getChunk((int)pos.x, (int)pos.y, (int)pos.z + 4) != null)
            {
                ...
                if (adjacentChunk.planetchunk.GetComponent<sccsplanetchunkrev12>().GetByte((int)indexX, (int)indexY, (int)0, adjacentChunk) == 1)
                {
                    ////Debug.Log("adjacent chunk left exists");
                    adjacentChunk.planetchunk.GetComponent<sccsplanetchunkrev12>().SetByte((int)indexX, (int)indexY, (int)0, 1, adjacentChunk);
                    adjacentChunk.planetchunk.GetComponent<sccsplanetchunkrev12>().Regenerate(adjacentChunk);
                    adjacentChunk.planetchunk.GetComponent<sccsplanetchunkrev12>().buildMesh(adjacentChunk);
                }
            }
...
if (planetmanager.GetComponent<sccsproceduralplanetbuilderrev12>().getChunk((int)hit.transform.position.x, (int)hit.transform.position.y, (int)hit.transform.position.z) != null)
{
    ...
    if (Input.GetMouseButtonDown(0))
    {
        ...
        planetchunk.GetComponent<sccsplanetchunkrev12>().Regenerate(adjacentChunk);
        planetchunk.GetComponent<sccsplanetchunkrev12>().buildMesh(adjacentChunk);
