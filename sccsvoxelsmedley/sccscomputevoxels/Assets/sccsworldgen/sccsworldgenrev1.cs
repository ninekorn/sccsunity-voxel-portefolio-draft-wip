...
public class sccsworldgenrev1 : MonoBehaviour
{
                    ...
                    for (int z = -sizebz; z <= sizebz + sizefz; z++)
                    {
                        ...
                        */
                        ...
                        //for (int f = 0; f < 6; f++)
                        {
                            ...
                            theunqueuedobject.transform.parent = this.transform;
                            ...
                            chunkarray[facetype][theindex] = new sccsworldgenrev1.chunkdata();
